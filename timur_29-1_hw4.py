...
def start():
    boss = Boss('Roshan', 1900, 50)
    golem = Golem('Tiny', 450, 0)
    witcher = Witcher('Witch Doctor', 340, 0)
    warrior = Warrior('Yournero', 280, 10)
    magic = Magic('Rubick', 260, 15)
    berserk = Berserk('Troll', 270, 15)
    doc = Medic('Estes', 250, 5, 15)
    thor = Thor('Zeus', 300, 15)
    eudora = Eudora('Eudora', 240, 10)
    heroes_list = [witcher, golem, warrior, doc, thor, eudora, magic, berserk]
